...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(msg.startsWith('409') ? 'Email already registered.' : 'Sign up failed. Please try again.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white rounded-lg shadow-md w-full max-w-md p-8">
        ...
        <h1 className="text-2xl font-semibold text-[#032147] mb-6">Create an account</h1>
        ...
        <p className="mt-6 text-sm text-[#888888] text-center">
          ...
          <a href="/login" className="text-[#209dd7] hover:underline font-medium">
            Sign in
          </a>
        </p>
      </div>
